...
# CONFIG
# --------------------------------------------------
DATA_FILE = "data/usdjpy_data.csv"
RESULTS_DIR = "results"
...
def load_data(path: str) -> pd.DataFrame:
    """
    Load USD/JPY CSV, clean it, and return a DataFrame with:
    - datetime index
...
def plot_equity(df: pd.DataFrame, out_path: str) -> None:
    ...
    plt.title("USD/JPY – Cumulative Returns")
    plt.xlabel("Date")
...
def main():
    print("=" * 70)
    print("USD/JPY MOVING AVERAGE CROSSOVER STRATEGY")
    print("=" * 70)
    ...
    plot_path = os.path.join(RESULTS_DIR, "usdjpy_backtest_equity.png")
