...
def load_data(path: str) -> pd.DataFrame:
    """
    Load GBP/USD CSV, clean it, and return a DataFrame with:
    - datetime index
...
def plot_equity(df: pd.DataFrame, out_path: str) -> None:
    ...
    plt.title("GBP/USD – Cumulative Returns")
    plt.xlabel("Date")
...
def main():
    print("=" * 70)
    print("GBP/USD MOVING AVERAGE CROSSOVER STRATEGY")
    print("=" * 70)
    ...
    plot_path = os.path.join(RESULTS_DIR, "gbpusd_backtest_equity.png")
